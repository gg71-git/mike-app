<?php
$page = "users";        // technischer Name für Datei/API
$pagename = "Benutzer"; // lesbarer Name für Überschrift, Buttons etc.
$tab_ID = "user_ID";   // Primärschlüsselfeld dieser Tabelle
$showCodeBtn = true;   // Mail an User senden
$pageclass = 'users';         // CSS-Klasse für Farbe
