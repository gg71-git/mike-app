<?php
$page = "helpdesks";        // technischer Name für Datei/API
$pagename = "Helpdesks"; // lesbarer Name für Überschrift, Buttons etc.
$tab_ID = "helpdesk_ID";   // Primärschlüsselfeld dieser Tabelle
$showCodeBtn = false;   // Mail an User senden
$pageclass = 'helpdesks';         // CSS-Klasse für Farbe
